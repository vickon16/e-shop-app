...
import { updateOrderStatusAction } from '@/actions/mutations/order.mutation';
import { GET_ORDER_DETAILS } from '@/actions/base-action-constants';
...
export default function OrderDetailsPage() {
  ...
  const handleStatusChange = (newStatus: TOrderStatus) => {
    updateStatus({ orderId, orderStatus: newStatus });
  };
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        <div>
          ...
          <div className="text-xs text-muted-foreground mt-2 flex items-center gap-2">
            ...
            <Select
              value={order.orderStatus as TOrderStatus}
              onValueChange={handleStatusChange}
              disabled={isUpdating}
            >
              <SelectTrigger className="h-7 cursor-pointer w-[140px] text-xs">
