...
import { GET_SELLER } from '@/actions/base-action-constants';
...
const SellerSettingsPage = () => {
  ...
  const handleShopAction = (type: 'delete' | 'restore') => {
    deleteRestoreShop(type, {
      onSuccess: (data) => {
        ...
        queryClient.invalidateQueries({ queryKey: [GET_SELLER] });
  ...
  const isDeleted = !!seller?.shop?.deletedAt;
