...
export default function AdminLoginPage() {
  ...
  const loginMutation = useBaseMutation<TLoginSchema, unknown>({
    endpoint: '/auth/login?accountType=admin',
  });
  ...
  return (
    <div className="w-full flex justify-center items-center h-screen">
      <div className="w-full max-w-130 p-8 bg-background/80 shadow-lg rounded-lg">
