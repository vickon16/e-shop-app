...
const port = env.LOGGER_SERVICE_PORT;
...
app.use('/api/logger/docs', swaggerUi.serve, swaggerUi.setup(openApiDocument));
...
const server = app.listen(port, host, () => {
  ...
  console.log(
    `Swagger Docs available at http://${host}:${port}/api/logger/docs`,
  );
});
